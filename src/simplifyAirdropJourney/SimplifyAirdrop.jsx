  ...
  return (
    <div className="flex justify-center">
      <div className="bg-white ">
        <div>
          <h2 className="font-medium text-[48px] text-center">
            Simplify your airdrop
          </h2>
          <h2 className="font-medium text-[48px] text-center">
            journey: AutoAir AI,
          </h2>
          <h2 className="font-medium text-[48px] text-center">
            One-click farming solution
          </h2>
          <p className="text-gray9 font-medium text-[20px] text-center">
          ...
          <div className="lg:w-6/12 md:w-12/12 md:rounded-[20px] md:bg-white h-[552px]" style={{border:"solid red 1px"}}>
            <div>
              ...
              <div className="lg:flex flex-row-reverse flex justify-end me-[32px] ">
                ...
                <img
                  className=""
                  src="https://autoair.xyz/icon/check_v2.svg"
                  alt=""
                />
              </div>
