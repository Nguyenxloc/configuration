...
export default function SideBar() {
    ...
    {link:"hs-network-list-ui",name:"Hs network list UI"},{link:"pair-info",name: "Trading asset"},{link:"hold-station", name:"holdstation.com"},
    {link:"accessible-mobile",name:"Accessible on Mobile & web"},{link:"hold-paid-across", name:"Hold paid across"},{link:"send-assets", name:"Send assets"}]
    );
