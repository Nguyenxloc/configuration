...
export default function SideBar(props) {
    ...
    return (
        <Sidebar backgroundColor={"white"} width={"220px"}>
            ...
            >
                <p className="ms-3" style={{fontSize: 20}}><strong><i className="bi bi-database-check me-2"></i>CryptoChecker</strong>
                </p>
                <MenuItem active={x1} onClick={()=> (props.onClickFunction(1),resetAll(),setX1(true))} ><i className="bi bi-house me-2"></i>Home</MenuItem>
                <MenuItem active={x2} onClick={()=> (props.onClickFunction(2),resetAll(),setX2(true))}><i className="bi bi-chat-left-dots me-2"></i>#New feature 1</MenuItem>
